...
public class PagamentoApi {
	...
	public ResponseEntity<PagamentoDto> consultaPagamento(@ParameterObject @PathVariable @NotNull
            									 		  @Schema(description = "Código do pedido no sistema", example = "be0846bc-3f60-449c-952d-20a8e74d5a0a")
            									 		  String id){
		logger.info("Consultar status pagamento do pedido: {}", id);
		
		PagamentoDto consultaPagamento = controller.consulta(id);
